...
switch(position){
    case 1 : console.log(`${horseName} finished in first place`)
    break;
    case 2 : console.log (`${horseName} finisdhed in second place`)
    break;
    case 3 : console.log(`$${horseName} finished in third place`)
    break;
    case 4 : console.log(`${horseName} finished in fourth place`)
    break;
}
